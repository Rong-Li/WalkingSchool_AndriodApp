...
public class AddMonitoredbyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_monitoredby);
        // Build the server proxy with token
        String token = SavedSharedPreference.getPrefUserToken(AddMonitoredbyActivity.this);
    ...
    private void populateList(){
        ...
        // Build Adapter
        mAdapter = new UserListAdapter(AddMonitoredbyActivity.this, allUsers);
    ...
    private void clickCallSetting(){
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View viewclicked, int position, long id) {
                ...
                // Make call to add
                Call<List<User>> caller = proxy.addUsertoMonitoredBy(userId, user);
                ServerProxyBuilder.callProxy(AddMonitoredbyActivity.this, caller, returnedUsers -> response(returnedUsers));
                finish();
            }
        });
    ...
    private void getUserLoggedin(){
        // Encode user email
        String email = SavedSharedPreference.getPrefUserEmail(AddMonitoredbyActivity.this);
        // Make call to retrieve user info
        Call<User> caller = proxy.getUserByEmail(email);
        ServerProxyBuilder.callProxy(AddMonitoredbyActivity.this, caller, returnedUser -> response(returnedUser));
